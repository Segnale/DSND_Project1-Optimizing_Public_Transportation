...
class KafkaConsumer:
    ...
    def on_assign(self, consumer, partitions):
        ...
        for partition in partitions:
            ...
            if self.offset_earliest is True:
                logger.info("Offset beginning for %s", self.topic_name_pattern)
    ...
    def _consume(self):
        ...
        if message is 0:
            ...
            logger.info(f"Error {message.error()} from consumer")
            return 0
        else:
    ...
    def close(self):
        ...
        self.consumer.close()
        logger.info(f"consumer {self.topic_name_pattern} is cleaned")
